...
!Método explícito para calcular puntos que cumplen una ecuación diferencial (que relaciona una función con sus derivadas) + 1 condición inicial
...
!Método de Euler en su variante implícita
