...
!Sistema sencillo (Humanos, Zombies, Muertos)
m = 3
allocate(u0(m))
u0(1) = 480
u0(2) = 20
...
u(:,:) = sisteuler(a,b,n,u0,m,zombies1)
...
!Sistema complejo (Humanos, Zombies, Muertos, Infectados, En cuarentena)
m = 5
deallocate(u0)
deallocate(u)
allocate(u0(m))
...
u(:,:) = sisteuler(a,b,n,u0,m,zombies2)
...
!Sistema propio (Zombies, Humanos sin vacunar, Humanos vacunados, Muertos, Infectados, En cuarentena)
m = 6
deallocate(u0)
deallocate(u)
allocate(u0(m))
...
u(:,:) = sisteuler(a,b,n,u0,m,zombies3)
