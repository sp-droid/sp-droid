...
def MSE(y,a): #Mean squared error
    m = y.shape[1]
    return 1/m
def d_MSE(y,a): #Mean squared error
    m = y.shape[1]
    return 1/m
...
# NN and training
neuralnetwork = ANN(nodes, activation, lossname)
...
x = np.array([[0], [1]])
y = neuralnetwork.testwithplot(x,len(x.T), nodes)
print('\n')
print(y)
